...
void Sift::Writer::handleMemoryRequest(Record &respRec)
{
   ...
   else if (type == MemWrite || type == MemCLFLUSH || type == MemCLINVAL || type == MemNOT || type == MemAND || type == MemOR || type == MemNAND || type == MemNOR || type == MemXOR)
   {
      #if VERBOSE > 0
      ...
      if (type == MemCLFLUSH)
      {
          printf("Sift::Writer::handleMemoryRequest received CLFLUSH cmd!\n");
      }
      if (type == MemCLINVAL)
      {
          printf("Sift::Writer::handleMemoryRequest received CLINVAL cmd!\n");
      }
      if (type == MemNOT)
      {
          printf("Sift::Writer::handleMemoryRequest received NOT cmd!\n");
      }
      if (type == MemAND)
      {
          printf("Sift::Writer::handleMemoryRequest received AND cmd!\n");
      }
      if (type == MemOR)
      {
          printf("Sift::Writer::handleMemoryRequest received OR cmd!\n");
      }
      if (type == MemNAND)
      {
          printf("Sift::Writer::handleMemoryRequest received NAND cmd!\n");
      }
      if (type == MemNOR)
      {
          printf("Sift::Writer::handleMemoryRequest received NOR cmd!\n");
      }
      if (type == MemXOR)
      {
          printf("Sift::Writer::handleMemoryRequest received XOR cmd!\n");
      }
