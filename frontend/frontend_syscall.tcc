  ...
  Sift::MemoryOpType mem_op, uint64_t d_addr, uint8_t* data_buffer, uint32_t data_size)
{
  ...
  else if (mem_op == Sift::MemWrite || mem_op == Sift::MemCLFLUSH || mem_op == Sift::MemCLINVAL || mem_op == Sift::MemNOT || mem_op == Sift::MemAND || mem_op == Sift::MemOR || mem_op == Sift::MemNAND || mem_op == Sift::MemNOR || mem_op == Sift::MemXOR || mem_op == Sift::MemCIMREAD || mem_op == Sift::MemAND_S || mem_op == Sift::MemOR_S)
  {
      if (mem_op == Sift::MemCLFLUSH)
      {
          printf("FrontendSyscallModelBase <T>::handleAccessMemory received CLFLUSH cmd!\n");
      }
      if (mem_op == Sift::MemCLINVAL)
      {
          printf("FrontendSyscallModelBase <T>::handleAccessMemory received CLINVAL cmd!\n");
      }
      if (mem_op == Sift::MemNOT)
      {
          printf("FrontendSyscallModelBase <T>::handleAccessMemory received NOT cmd!\n");
      }
      if (mem_op == Sift::MemAND)
      {
          printf("FrontendSyscallModelBase <T>::handleAccessMemory received AND cmd!\n");
      }
      if (mem_op == Sift::MemOR)
      {
          printf("FrontendSyscallModelBase <T>::handleAccessMemory received OR cmd!\n");
      }
      if (mem_op == Sift::MemNAND)
      {
          printf("FrontendSyscallModelBase <T>::handleAccessMemory received NAND cmd!\n");
      }
      if (mem_op == Sift::MemNOR)
      {
          printf("FrontendSyscallModelBase <T>::handleAccessMemory received NOR cmd!\n");
      }
      if (mem_op == Sift::MemXOR)
      {
          printf("FrontendSyscallModelBase <T>::handleAccessMemory received XOR cmd!\n");
      }
      if (mem_op == Sift::MemCIMREAD)
      {
          printf("FrontendSyscallModelBase <T>::handleAccessMemory received CIMREAD cmd!\n");
      }
      if (mem_op == Sift::MemAND_S)
      {
          printf("FrontendSyscallModelBase <T>::handleAccessMemory received AND_S cmd!\n");
      }
      if (mem_op == Sift::MemOR_S)
      {
          printf("FrontendSyscallModelBase <T>::handleAccessMemory received OR_S cmd!\n");
      }
