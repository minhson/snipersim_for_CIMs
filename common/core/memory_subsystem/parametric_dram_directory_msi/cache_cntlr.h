   ...
   class CacheCntlr : ::CacheCntlr
   {
      private:
         ...
         struct {
           ...
           // added by MSON
           UInt64 clflushes_where[HitWhere::NUM_HITWHERES];
         ...
         // added by MSON
         HitWhere::where_t processFlushReqFromPrevCache(CacheCntlr* requester, Core::mem_op_t mem_op_type, IntPtr address, bool modeled, bool count, Prefetch::prefetch_type_t isPrefetch, SubsecondTime t_issue, bool have_write_lock);
         HitWhere::where_t processInvalReqFromPrevCache(CacheCntlr* requester, Core::mem_op_t mem_op_type, IntPtr address, bool modeled, bool count, Prefetch::prefetch_type_t isPrefetch, SubsecondTime t_issue, bool have_write_lock);
      ...
      public:
         ...
         // added by MSON
         HitWhere::where_t processFlushReqFromCore(
               ...
               bool modeled,
               bool count);
         HitWhere::where_t processInvalReqFromCore(
               Core::lock_signal_t lock_signal,
               Core::mem_op_t mem_op_type,
               IntPtr ca_address, UInt32 offset,
               Byte* data_buf, UInt32 data_length,
               bool modeled,
               bool count);
         HitWhere::where_t processCIMReqFromCore(
               Core::lock_signal_t lock_signal,
               Core::mem_op_t mem_op_type,
               IntPtr ca_address, UInt32 offset,
               Byte* data_buf, UInt32 data_length,
