...
Log::~Log()
{
   ...
   // for closing dramsim3 memory traces file
   if (_DRAMsim3File)
      fclose(_DRAMsim3File);
...
void Log::mem_trace(const char *format, ...)
{
   // comment it for DRAMsim3
   //FIXMEint tid = syscall(__NR_gettid);
